...
muonTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        looseId  = Var("passed(1)",bool, doc="muon is loose muon"),
        ...
        mediumId = Var("passed(2)",bool,doc="cut-based ID, medium WP"),
        mediumPromptId = Var("passed('CutBasedIdMediumPrompt')",bool,doc="cut-based ID, medium prompt WP"),
        tightId = Var("passed(8)",bool,doc="cut-based ID, tight WP"),
        ...
        pfIsoId = Var("passed(64)+passed(128)+passed(256)+passed(512)+passed(1024)+passed(16777216)","uint8",doc="PFIso ID from miniAOD selector (1=PFIsoVeryLoose, 2=PFIsoLoose, 3=PFIsoMedium, 4=PFIsoTight, 5=PFIsoVeryTight, 6=PFIsoVeryVeryTight)"),
